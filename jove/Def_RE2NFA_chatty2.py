...
def p_expression_plus_id(t):
    '''expression : catexp'''
    print('applying production rule \'expression: catexp\'')
...
def p_expression_cat(t):
    ...
    print('using production rule \'catexp: catexp ordyexp\' combining their NFAs')
...
def p_expression_cat_id(t):
    '''catexp :  ordyexp'''
    print('applying production rule \'catexp: ordyexp\'')
    # Simply inherit the attribute from t[1] and pass on
    t[0] = t[1]
...
def p_expression_ordy_str(t):
    'ordyexp : STR'
    print('found a letter', t[1], 'and generated the appropriate NFA')
